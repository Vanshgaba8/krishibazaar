...
class _MarketDataPageState extends State<MarketDataPage> {
  ...
  Future<void> _fetchMarketData(String market) async {
    setState(() {
      _isLoading = true;
      _error = null;
    });
    ...
    final apiUrl =
        'https://api.data.gov.in/resource/9ef84268-d588-465a-a308-a864a43d0070?api-key=$apiKey&format=json&filters[market]=$market';
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          if (_marketData.isEmpty) {
            _error = 'No data found for the specified market.';
          }
        });
      } else {
        setState(() {
